...
${OBJECTDIR}/core/mdlScan.o: core/mdlScan.mc
	${MKDIR} -p ${OBJECTDIR}/core
	${RM} "$@.d"
	$(COMPILE.c) -g -I/C/win32app/ustation/mdl/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/mdlScan.o core/mdlScan.mc
...
${OBJECTDIR}/photoReader.o: photoReader.mc
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I/C/win32app/ustation/mdl/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/photoReader.o photoReader.mc
